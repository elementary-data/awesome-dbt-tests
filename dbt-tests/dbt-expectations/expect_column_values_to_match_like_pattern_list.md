### expect_column_values_to_match_like_pattern_list ([source](https://github.com/calogica/dbt-expectations/blob/main/README.md#expect_column_values_to_match_like_pattern_list))
