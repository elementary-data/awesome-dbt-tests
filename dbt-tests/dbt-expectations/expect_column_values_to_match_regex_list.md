### expect_column_values_to_match_regex_list ([source](https://github.com/calogica/dbt-expectations/blob/main/README.md#expect_column_values_to_match_regex_list))
